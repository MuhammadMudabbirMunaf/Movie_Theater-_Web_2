...
//     // console.log(event);
//     let b = event.style.backgroundColor = "yellow";
//     let c = event.style.border = "2px solid black";
//     let d = event.style.fontSize = "25px";
//     let e = event.style.color = "black";
//     let a = event.getAttribute("id");
//     arr.push(a, b, c, d, f);
//     let f = JSON.stringify(arr);
//     window.localStorage.setItem("seats", f);
//     event.disabled = true;
//     // console.log(c);
// }
